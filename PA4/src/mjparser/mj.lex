...
number=[0-9]
whitespace=[ \t\r\n\f]
toneLit=(A|As|B|C|Cs|D|Ds|E|F|Fs|G|Gs)[3]
buttonLit=(A|B|Up|Down|Left|Right)
colorLit=(RED|ORANGE|GREEN|BLUE|VIOLET|WHITE|DARK|YELLOW)
sign=[-]
meggyColor=(meggyColor)
meggyTone=(meggyTone)
meggyButton=(MeggyButton)
EOL=(\r|\n|\r\n)
...
(_|{letter})+(_|{letter}|{number})*  {return new Symbol(sym.ID,new SymbolValue(yyline+1, yychar+1, yytext()));}
